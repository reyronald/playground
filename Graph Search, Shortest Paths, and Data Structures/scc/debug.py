...
RESULT = Graph.create_from_file(ROOT + "tc6.txt").find_scc()
assert RESULT == '3,1,1,0,0'

RESULT = Graph.create_from_file(ROOT + "tc7.txt").find_scc()
assert RESULT == '7,3,0,0,0'

RESULT = Graph.create_from_file(ROOT + "tc8.txt").find_scc()
assert RESULT == '4,2,1,1,1'

RESULT = Graph.create_from_file(ROOT + "tc9.txt").find_scc()
